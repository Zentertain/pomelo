...
Service.prototype.injectNewRedic = function(cb) {
  if (this.app.get('newrelicEnabled')) {
    newrelic.createTracer(routeRecord.method, function() {
      cb();
    });
  } else {
    cb();
